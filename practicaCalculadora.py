...
pantalla.config(background="black", fg="#03f943", justify="right",width=12,font=('calibri', 25, 'bold'))
...
botonPow=Button(miFrame, text="^", width=3, command=lambda:potencia(numeroPantalla.get()))
botonPow.grid(row=2, column=5)
...
botonRaiz2=Button(miFrame, text="√", width=3, font=('calibri', 20),command=lambda:raiz2(numeroPantalla.get()))
botonRaiz2.grid(row=3, column=5, rowspan=5)
